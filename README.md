...
- The worker process exits after 60 seconds idle by default.
...
```bash
# keep models loaded
uv run voxt-qwen3-asr --unload-after-sec 0

# unload sooner/later
uv run voxt-qwen3-asr --unload-after-sec 120
...
HF_ENDPOINT=https://huggingface.co uv run voxt-qwen3-asr
```
